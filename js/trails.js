const trailsData = [
  ...
  // JDay Trail Series - Embedded Trails
  {
    id: "jday-01",
    name: "JDay 01",
    distance: 7.9,
    type: "jday-series",
    kmlFilename: "JDay01-7.9km.kml",
    description: "JDay 01 trail - 7.9km hiking route with scenic views and moderate difficulty."
  },
  {
    id: "jday-02",
    name: "JDay 02",
    distance: 10.1,
    type: "jday-series",
    kmlFilename: "JDay02-10.1km.kml",
    description: "JDay 02 trail - 10.1km hiking route with varied terrain and beautiful landscapes."
  },
  {
    id: "jday-03",
    name: "JDay 03",
    distance: 10.1,
    type: "jday-series",
    kmlFilename: "JDay03-10.1km.kml",
    description: "JDay 03 trail - 10.1km hiking route offering challenging terrain and rewarding views."
  },
  {
    id: "jday-04",
    name: "JDay 04",
    distance: 6.4,
    type: "jday-series",
    kmlFilename: "JDay04-6.4km.kml",
    description: "JDay 04 trail - 6.4km shorter route perfect for a half-day adventure."
  },
  {
    id: "jday-05",
    name: "JDay 05",
    distance: 22.5,
    type: "jday-series",
    kmlFilename: "JDay05-22.5km.kml",
    description: "JDay 05 trail - 22.5km extended route for experienced hikers seeking a full-day challenge."
  },
  {
    id: "jday-06",
    name: "JDay 06",
    distance: 14.5,
    type: "jday-series",
    kmlFilename: "JDay06-14.5km.kml",
    description: "JDay 06 trail - 14.5km moderate route with diverse ecosystems and wildlife viewing opportunities."
  },
  {
    id: "jday-07",
    name: "JDay 07",
    distance: 11,
    type: "jday-series",
    kmlFilename: "JDay07-11km.kml",
    description: "JDay 07 trail - 11km route featuring forest paths and mountain vistas."
  },
  {
    id: "jday-08",
    name: "JDay 08",
    distance: 14.2,
    type: "jday-series",
    kmlFilename: "JDay08-14.2km.kml",
    description: "JDay 08 trail - 14.2km route with elevation changes and panoramic viewpoints."
  },
  {
    id: "jday-09",
    name: "JDay 09",
    distance: 7.7,
    type: "jday-series",
    kmlFilename: "JDay09-7.7km.kml",
    description: "JDay 09 trail - 7.7km scenic route ideal for nature photography and bird watching."
  },
  {
    id: "jday-10",
    name: "JDay 10",
    distance: 5.3,
    type: "jday-series",
    kmlFilename: "JDay10-5.3km.kml",
    description: "JDay 10 trail - 5.3km easy route suitable for beginners and families."
  },
  {
    id: "jday-11",
    name: "JDay 11",
    distance: 11.2,
    type: "jday-series",
    kmlFilename: "JDay11-11.2km.kml",
    description: "JDay 11 trail - 11.2km route through indigenous forests and grasslands."
  },
  {
    id: "jday-12",
    name: "JDay 12",
    distance: 4.9,
    type: "jday-series",
    kmlFilename: "JDay12-4.9km.kml",
    description: "JDay 12 trail - 4.9km short route perfect for a morning or afternoon hike."
  }
];
